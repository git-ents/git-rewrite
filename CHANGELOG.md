...
## [0.0.3](https://github.com/git-ents/git-rewrite/compare/v0.0.4...v0.0.3) (2026-03-01)
...
* Add `git-filter` CLI ([a49f564](https://github.com/git-ents/git-rewrite/commit/a49f564d7082083c1e1a22ea46e77112e6e58a02))
...
* Add library crate: `git-filter-tree` ([21acf6d](https://github.com/git-ents/git-rewrite/commit/21acf6d206ca2af0b4726ba533fd7627d2a20a98))
* Add man-page generation via `clap_mangen` ([2a1a4b6](https://github.com/git-ents/git-rewrite/commit/2a1a4b6b6cf95bad79b4bf705d2a831490f3fab9))
* Enable publishing for initial release ([ed7a912](https://github.com/git-ents/git-rewrite/commit/ed7a912d30d45fdd1ef92a33f7cdfb35870ca626))
* Update crate metadata ([b38c497](https://github.com/git-ents/git-rewrite/commit/b38c49726869f3db013633f8f8f34f0fd6dfe331))


### Reverts

* "chore: add `main` to allowed commit scopes" ([957395e](https://github.com/git-ents/git-rewrite/commit/957395e61cd5ca12bc5102eb8db4b6e06ff23290))
